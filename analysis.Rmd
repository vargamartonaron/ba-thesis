...
h1_priors <- c(
  set_prior("normal(0, 30)", class = "b", coef = "congruencyincongruent"),
  set_prior("normal(0, 15)", class = "b", coef = "prev_congruencyincongruent"),
  set_prior("normal(0, 5)", class = "b", coef = condition_positive, hb = 0),
  set_prior("normal(0, 5)", class = "b", coef = condition_negative, lb = 0),
  set_prior("normal(0, 5)", class = "b", coef = condition_neutral),
